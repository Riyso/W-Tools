...
local COLORS = {
    [0] = {back = {0.07, 0.07, 0.07, 1.00},    text = {1, 1, 1, 1}, icon = {1, 1, 1, 1}, border = {1, 0, 0, 0}},--{back = imgui.ImVec4(0.1, 0.13, 0.17, 1), text = imgui.ImVec4(1, 1, 1, 1), icon = imgui.ImVec4(1, 0, 0.3, 1), border = imgui.ImVec4(1, 0, 0.3, 1)},
    [1] = {back = {0.07, 0.07, 0.07, 1.00},    text = {1, 1, 1, 1}, icon = {1, 1, 1, 1}, border = {1, 0, 0, 0}},
    [2] = {back = {0.07, 0.07, 0.07, 1.00},    text = {1, 1, 1, 1}, icon = {1, 1, 1, 1}, border = {1, 0, 0, 0}},
    [3] = {back = {0.07, 0.07, 0.07, 1.00},    text = {1, 1, 1, 1}, icon = {1, 1, 1, 1}, border = {1, 0, 0, 0}},
    [4] = {back = {0.07, 0.07, 0.07, 1.00},    text = {1, 1, 1, 1}, icon = {1, 1, 1, 1}, border = {1, 0, 0, 0}},
...
local newFrame = imgui.OnFrame(
    ...
    function(self)
        ...
        imgui.SetWindowPosVec2(imgui.ImVec2(resX - 10 - winSize.x, 500))
