...
local COLORS = {
    [0] = {back = {0.85, 0.73, 0.10, 1.00},    text = {0, 0, 0, 1}, icon = {0, 0, 0, 1}, border = {1, 0, 0, 0}},--{back = imgui.ImVec4(0.1, 0.13, 0.17, 1), text = imgui.ImVec4(1, 1, 1, 1), icon = imgui.ImVec4(1, 0, 0.3, 1), border = imgui.ImVec4(1, 0, 0.3, 1)},
    [1] = {back = {0.85, 0.73, 0.10, 1.00},    text = {0, 0, 0, 1}, icon = {0, 0, 0, 1}, border = {1, 0, 0, 0}},
    [2] = {back = {0.85, 0.73, 0.10, 1.00},    text = {0, 0, 0, 1}, icon = {0, 0, 0, 1}, border = {1, 0, 0, 0}},
    [3] = {back = {0.85, 0.73, 0.10, 1.00},    text = {0, 0, 0, 1}, icon = {0, 0, 0, 1}, border = {1, 0, 0, 0}},
    [4] = {back = {0.85, 0.73, 0.10, 1.00},    text = {0, 0, 0, 1}, icon = {0, 0, 0, 1}, border = {1, 0, 0, 0}},
    [5] = {back = {1.00, 1.00, 1.00, 1.00},    text = {0, 0, 0, 1}, icon = {0, 0, 0, 1}, border = {1, 0, 0, 0}},--{back = imgui.ImVec4(0.1, 0.13, 0.17, 1), text = imgui.ImVec4(1, 1, 1, 1), icon = imgui.ImVec4(1, 0, 0.3, 1), border = imgui.ImVec4(1, 0, 0.3, 1)},
    [6] = {back = {1.00, 1.00, 1.00, 1.00},    text = {0, 0, 0, 1}, icon = {0, 0, 0, 1}, border = {1, 0, 0, 0}},
    [7] = {back = {1.00, 1.00, 1.00, 1.00},    text = {0, 0, 0, 1}, icon = {0, 0, 0, 1}, border = {1, 0, 0, 0}},
    [8] = {back = {1.00, 1.00, 1.00, 1.00},    text = {0, 0, 0, 1}, icon = {0, 0, 0, 1}, border = {1, 0, 0, 0}},
    [9] = {back = {1.00, 1.00, 1.00, 1.00},    text = {0, 0, 0, 1}, icon = {0, 0, 0, 1}, border = {1, 0, 0, 0}},
}
...
EXPORTS = {
    ...
    ICON = {
        ...
        [4] = fa.ICON_FA_WRENCH,
        [5] = fa.ICON_FA_INFO_CIRCLE,
        [6] = fa.ICON_FA_CHECK,
        [7] = fa.ICON_FA_TIMES,
        [8] = fa.ICON_FA_EXCLAMATION,
        [9] = fa.ICON_FA_WRENCH
    },
...
local newFrame = imgui.OnFrame(
    ...
    function(self)
        ...
        imgui.SetWindowPosVec2(imgui.ImVec2(resX - 172 - winSize.x, 700))
        
        -- цикл от последнего элемента к первому, чтобы новые сообщения отображались сверху
        for k = #list, 1, -1 do
            local data = list[k]
            ...
            local size = imgui.ImVec2(25 + iconSize.x + 5 + textSize.x + 5, 5 + textSize.y + 20)

            local winSize = imgui.GetWindowSize()
            if winSize.x > size.x + 50 then
            ...
            imgui.BeginChild('toastNotf:'..tostring(k)..tostring(data.text), size, true, imgui.WindowFlags.NoScrollbar + imgui.WindowFlags.NoScrollWithMouse)
                ...
                imgui.SetCursorPos(imgui.ImVec2(12, size.y / 2 - iconSize.y / 2))
                ...
                imgui.SetCursorPos(imgui.ImVec2(15 + iconSize.x + 5, size.y / 2 - textSize.y / 2))
